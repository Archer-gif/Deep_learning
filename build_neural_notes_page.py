...
MD_PATH = ROOT / "neural-network-foundations-notes.md"
OUT_PATH = ROOT / "neural-network-foundations.html"
...
<body>
  <div class="layout">
    ...
    <main>
{body}
      <div class="footer">由 neural-network-foundations-notes.md 生成，可直接上传到 GitHub Pages。</div>
    </main>
  </div>
  <script>
