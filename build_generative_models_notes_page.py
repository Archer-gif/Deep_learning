...
MD_PATH = ROOT / "generative-models-notes.md"
OUT_PATH = ROOT / "generative-models.html"
...
def slugify(title: str, index: int) -> str:
    ...
    mapping = {
        "生成式模型复习笔记": "overview",
        "复习优先级": "priority",
        "生成模型到底在学什么": "generative-goal",
        "VAE 的核心动机": "vae-motivation",
        "VAE 的数学原理": "vae-math",
        "VAE 损失函数：重建项和 KL 正则项": "vae-loss",
        "重参数化技巧": "reparameterization",
        "VAE 的生成能力与局限": "vae-generation",
        "GAN 基本架构": "gan",
        "Diffusion Model 总览": "diffusion-overview",
        "Diffusion 去噪模型设计": "diffusion-denoiser",
        "Diffusion 训练流程": "diffusion-training",
        "Diffusion 推理与条件生成": "diffusion-inference",
        "隐空间扩散与 Stable Diffusion": "latent-diffusion",
...
<body>
  <div class="layout">
    ...
    <main>
{body}
      <div class="footer">由 deep-vision-models-notes.md 生成，可直接上传到 GitHub Pages。</div>
    </main>
  </div>
  <script>
