...
MD_PATH = ROOT / "representation-learning-notes.md"
OUT_PATH = ROOT / "representation-learning.html"
...
def slugify(title: str, index: int) -> str:
    ...
    mapping = {
        ...
        "表征学习复习笔记": "overview",
        "复习优先级": "priority",
        "表征学习总览": "representation-overview",
        "Pretext 任务": "pretext",
        "对比学习": "contrastive-learning",
        "SimCLR 的网络结构和输入": "simclr-architecture",
        "SimCLR 的损失函数 NT-Xent": "simclr-loss",
        "Word2Vec 与 Skip-Gram": "skip-gram",
        "语言自监督学习": "language-self-supervision",
        "图像自监督的新方向": "image-self-supervision",
        "表征学习一页速记": "representation-summary",
        "图像表示与 CNN 动机": "image-cnn",
        "卷积计算": "convolution",
        "步长、填充与输出尺寸": "stride-padding",
        "感受野": "receptive-field",
        "池化层": "pooling",
        "1x1 卷积": "conv-1x1",
        "CNN 结构与全连接过渡": "cnn-fc",
        "经典深度视觉模型": "classic-models",
        "ResNet 结构": "resnet",
        "目标检测基础": "detection",
        "R-CNN 到 YOLO 的核心改进": "rcnn-yolo",
        "RPN 与 Selective Search": "rpn-selective",
        "分割模型与上采样": "segmentation",
        "课件补充内容": "survey",
        "一页速记": "summary",
    }
...
def main() -> None:
    md = MD_PATH.read_text(encoding="utf-8").lstrip("\ufeff")
...
<body>
  <div class="layout">
    ...
    <main>
{body}
      <div class="footer">由 representation-learning-notes.md 生成，可直接上传到 GitHub Pages。</div>
    </main>
  </div>
  <script>
